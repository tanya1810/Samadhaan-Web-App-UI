...
<div id="content-wrapper" className="d-flex flex-column">
  ...
  <div className="d-sm-flex align-items-center justify-content-between mt-4 mb-4">
          <h1 className="h1 mb-2 text-gray-800"><b>Department City</b></h1>
       </div>
        <div className="row">
...
<div className="row no-gutters align-items-center">
               ...
               <div className="text-xs font-weight-bold text-primary text-uppercase mb-1">Complaints</div>
         ...
         <div className="col-xl-3 col-md-6 mb-4">
            <div className="card border-left-success shadow h-100 py-2">
             <div className="card-body">
                <div className="row no-gutters align-items-center">
           <div className="col mr-2">
                    <div className="text-xs font-weight-bold text-success text-uppercase mb-1">Solved Complaints</div>
                    <div className="h5 mb-0 font-weight-bold text-gray-800">2000</div>         
...
<div className="text-xs font-weight-bold text-warning text-uppercase mb-1">Pending Requests</div>
       ...
       <div className="card border-left-danger shadow h-100 py-2">
          ...
          <div className="row no-gutters align-items-center">
               <div className="col mr-2">
                 <div className="text-xs font-weight-bold text-danger text-uppercase mb-1">Ignored Complaints</div>
                 <div className="h5 mb-0 font-weight-bold text-gray-800">1000</div>
                  <div className="h5 mb-0 font-weight-bold text-gray-800">25%</div>
             </div>
                <div className="col-auto">
  ...
  <tbody>
   ...
   <th scope="row">Average No. of Complaints per day</th>
     ...
     <tr>
    <th scope="row">Average No. of Resolved Complaints per day</th>
          <td>4</td>
        </tr>
        <tr>
